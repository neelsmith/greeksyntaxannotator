        ...
        function renderVerbalUnitTokenGrouping() {
            ...
            for (const token of sortedTokens) {
                ...
                if (currentTokenVU) {
                    ...
                    // Create a span for the token text to apply specific styles
                    const tokenTextSpan = document.createElement('span');
                    tokenTextSpan.textContent = token.text;

                    // Apply styles based on node1Rel of this token
            ...
            relevantTokens.forEach(token => {
                ...
                const createNumberInput = (currentValue, key, relData) => {
                    ...
                    input.onchange = (e) => {
                        ...
                        checkAndEnableMode4(); 
                        checkAndShowVerbalUnitTokenGrouping(); // Update grouping display as relations change
                    };
                    return input;
                };
